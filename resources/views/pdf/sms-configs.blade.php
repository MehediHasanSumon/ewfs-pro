...
<head>
    <meta charset="utf-8">
    <title>SMS Configurations List</title>
    <style>
        body {
...
<body>
    ...
    <div class="title-section">
        <div class="title-box">SMS Configurations List</div>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <span style="color: {{ $config->status ? 'green' : 'red' }}; font-weight: bold;">
            ...
            @empty
            <tr>
                <td colspan="5" class="text-center" style="padding: 20px; color: #999;">No SMS configurations found</td>
            </tr>
            @endforelse
        </tbody>
    </table>

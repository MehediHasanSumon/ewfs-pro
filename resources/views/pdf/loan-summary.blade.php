...
<head>
    <meta charset="utf-8">
    <title>Loan Summary - {{ $loanAccount['name'] }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="title-section">
        <div class="title-box">Loan Summary</div>
    </div>
    ...
    <div class="loan-info">
        <table>
            ...
            <tr>
                <td><strong>Total Loan:</strong> {{ number_format($totalLoan) }}</td>
    ...
    @php
        $grandTotal = collect($recentLoans)->sum('amount');

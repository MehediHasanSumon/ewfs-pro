...
<head>
    <meta charset="utf-8">
    <title>Receipt Summary - {{ $employee->employee_name }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="title-section">
        <div class="title-box">Receipt Summary</div>
    </div>
    ...
    @if(count($receipts) > 0)
    @php
        $grandTotal = collect($receipts)->sum('amount');

...
<head>
    <meta charset="utf-8">
    <title>Salary Summary - {{ $employee->employee_name }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="title-section">
        <div class="title-box">Salary Summary</div>
    </div>
    ...
    @php
        $grandTotal = collect($salaryPayments)->sum('amount');
    ...
    @include('pdf.components.footer')
        <div class="footer-right">
            Total Salary Payments: {{ count($salaryPayments) }}
        </div>
    </div>
</body>
</html>
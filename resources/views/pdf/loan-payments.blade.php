...
<head>
    <meta charset="utf-8">
    <title>Loan Payments - {{ $loanAccount['name'] }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="title-section">
        <div class="title-box">Loan Payments</div>
    </div>

    <div class="loan-info">
        <table>
            <tr>
                <td><strong>Account Name:</strong> {{ $loanAccount['name'] }}</td>
                <td><strong>Account Number:</strong> {{ $loanAccount['ac_number'] }}</td>
            </tr>
            <tr>
                <td><strong>Total Payment:</strong> {{ number_format($totalPayment) }}</td>
                <td><strong>Current Balance:</strong> {{ number_format($currentBalance) }}</td>
            </tr>
        </table>
    </div>
    ...
    @php
        $grandTotal = collect($recentPayments)->sum('amount');
    ...
    <div class="footer">
        ...
        <div class="footer-right">
            Total Payments: {{ count($recentPayments) }}
        </div>
    </div>
</body>
</html>
...
<body>
    ...
    <div class="title-section">
        <div class="title-box">General Ledger ({{ $startDate }} to {{ $endDate }})</div>
    </div>
    ...
    <div class="account-info">
        ...
        @if($account->group)
        <p><strong>Group:</strong> {{ $account->group->name }}</p>
        @endif
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="8" style="text-align: center; padding: 20px; color: #999;">No transactions found for the selected period</td>
            </tr>
            @endforelse
        </tbody>
    </table>

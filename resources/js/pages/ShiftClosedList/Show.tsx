            ...
            <div className="space-y-6 p-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button
                            variant="outline"
                            onClick={() => router.get('/shift-closed-list')}
                        >
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b dark:border-gray-700">
                                        <th className="p-3 text-left text-sm font-medium dark:text-gray-300">
                                            Dispenser
                                        </th>
                                        <th className="p-3 text-left text-sm font-medium dark:text-gray-300">
                                            Product
                                        </th>
                                        <th className="p-3 text-right text-sm font-medium dark:text-gray-300">
                                            Rate
                                        </th>
                                        <th className="p-3 text-right text-sm font-medium dark:text-gray-300">
                                            Start
                                ...
                                <tbody>
                                    {shiftClosed.dispenser_readings.map(
                                        (reading) => (
                                            <tr
                                                key={reading.id}
                                            ...
                                            >
                                                ...
                                                <td className="p-3 text-right text-sm dark:text-white">
                                                    {Number(
                                                        reading.item_rate,
                                                    ).toFixed(2)}
                                                </td>
                        ...
                        <CardContent>
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    ...
                                    <tbody>
                                        {shiftClosed.other_product_sales.map(
                                            (sale) => (
                                                <tr
                                                    key={sale.id}
                                                    className="border-b dark:border-gray-700"

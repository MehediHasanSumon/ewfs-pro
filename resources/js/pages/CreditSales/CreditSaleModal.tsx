...
export function CreditSaleModal({
    ...
    const loadEditData = async () => {
        ...
        try {
            const response = await fetch(
                `/credit-sales/${editingSale.id}/edit`,
            );
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const validProducts = data.products.filter(
            (p) => p.product_id && p.customer_id && p.vehicle_id && p.quantity,
        );
                ...
                <div className="grid grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <SearchableSelect
                            ...
                            onValueChange={(value) =>
                                updateProduct(0, 'customer_id', value)
                            }
                    ...
                    <div>
                        ...
                        <SearchableSelect
                            ...
                            onValueChange={(value) =>
                                updateProduct(0, 'vehicle_id', value)
                            }
                        ...
                        <table className="w-full border border-gray-300 dark:border-gray-600">
                            ...
                            <tfoot>
                                <tr className="border-t bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
                                    <td
                                        colSpan={5}
                                        className="p-2 text-right text-sm font-medium dark:text-gray-200"
                                    >
                                        Total
                                    </td>

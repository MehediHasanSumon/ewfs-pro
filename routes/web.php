...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('company-settings/{companySetting}/documents', [CompanyDocumentController::class, 'index'])->name('company-settings.documents.index');
    Route::post('company-settings/{companySetting}/documents', [CompanyDocumentController::class, 'store'])->name('company-settings.documents.store');
    Route::get('company-settings/{companySetting}/documents/{companyDocument}', [CompanyDocumentController::class, 'show'])->name('company-settings.documents.show');
    Route::get('company-settings/{companySetting}/documents/{companyDocument}/file', [CompanyDocumentController::class, 'file'])->name('company-settings.documents.file');
    Route::put('company-settings/{companySetting}/documents/{companyDocument}', [CompanyDocumentController::class, 'update'])->name('company-settings.documents.update');
    Route::delete('company-settings/{companySetting}/documents/{companyDocument}', [CompanyDocumentController::class, 'destroy'])->name('company-settings.documents.destroy');
